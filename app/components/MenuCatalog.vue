...
const SIZES = [
  ...
  { label: "Mittel", sub: "30 cm", extra: 2.0 },
  { label: "Groß", sub: "35 cm", extra: 4.0 },
  { label: "Jumbo", sub: "40 cm", extra: 6.0 },
];

const DOUGHS = [
  { label: "Klassisch", extra: 0.0 },
  { label: "Dünn & Knusprig", extra: 0.5 },
  { label: "Vollkorn", extra: 1.0 },
  { label: "Dicke Kruste", extra: 1.5 },
];
...
const sizeExtra = computed(() =>
  modal.item?.isPizza ? SIZES[modal.sizeIdx].extra : 0,
);
const doughExtra = computed(() =>
  modal.item?.isPizza ? DOUGHS[modal.doughIdx].extra : 0,
);
const unitPrice = computed(() =>
  modal.item ? modal.item.price + sizeExtra.value + doughExtra.value : 0,
);
  ...
  <section ref="sectionRef" id="menu" class="catalog">
    <div class="container">
      ...
      <div class="section-head reveal-up">
        ...
        <p class="section-sub">
          Frisch, ehrlich, lecker – entdecken Sie unsere gesamte Auswahl.
        </p>
      </div>
      ...
      <Transition name="tab-fade" mode="out-in">
        ...
        <!-- Salads -->
        <div
          v-else-if="menu.activeTab === 'salad'"
          key="salad"
          class="catalog-grid"
        >
        ...
        <div v-else key="drink" class="catalog-grid">
          <article v-for="d in menu.filteredDrinks" :key="d.id" class="card">
            ...
            <div class="card__body">
              <h3>
                {{ d.name }} <span class="card__vol">{{ d.vol }}</span>
              </h3>
              <p>{{ d.desc }}</p>
              <div class="card__footer">
            ...
            <fieldset v-if="modal.item?.isPizza" class="option-group">
              ...
              <div class="option-row">
                ...
                >
                  ...
                  <span v-if="size.extra > 0" class="chip-extra"
                    >+{{ fmt(size.extra) }}</span
                  >
                </button>
              </div>
            ...
            <fieldset v-if="modal.item?.isPizza" class="option-group">
              ...
              <div class="option-row">
                ...
                >
                  ...
                  <span v-if="dough.extra > 0" class="chip-extra"
                    >+{{ fmt(dough.extra) }}</span
                  >
                </button>
              </div>
            </fieldset>
