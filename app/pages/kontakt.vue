      ...
      <div class="contact-split reveal-up">
        ...
        <div class="contact-info-col">
          <div class="contact-info-col__head">
            ...
            <p>Wir sind für Sie da – persönlich, telefonisch oder per E-Mail.</p>
          </div>
            ...
            <div class="contact-item">
              ...
              <div class="contact-item__text">
                ...
                <table class="hours-table">
                  <tbody>
                    <tr><td>Mo – Fr</td><td>11:00 – 22:00</td></tr>
                    <tr><td>Samstag</td><td>12:00 – 23:00</td></tr>
            ...
            <div class="contact-item">
              <div class="contact-item__icon">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                  ...
                  <path d="M5 17a2 2 0 1 0 4 0 2 2 0 0 0-4 0M16 17a2 2 0 1 0 4 0 2 2 0 0 0-4 0" />
                </svg>
              </div>
              <div class="contact-item__text">
                <h4>Liefergebiet</h4>
        ...
        <div class="contact-form-col">
          ...
          <form v-if="!sent" class="contact-form" novalidate @submit.prevent="handleSubmit">
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input
                  ...
                  :class="{ 'cf-error': errors.fname, 'cf-ok': !errors.fname && form.fname }"
                  @blur="validate('fname')"
                />
              </div>
              <div class="form-group">
                ...
                <input
                  ...
                  :class="{ 'cf-error': errors.lname, 'cf-ok': !errors.lname && form.lname }"
                  @blur="validate('lname')"
                />
              </div>
            </div>
            ...
            <div class="form-row">
              <div class="form-group">
                ...
                <input
                  ...
                  autocomplete="email"
                  :class="{ 'cf-error': errors.email, 'cf-ok': !errors.email && form.email }"
                  @blur="validate('email')"
                />
              </div>
              <div class="form-group">
            ...
            <div class="form-group">
              ...
              <textarea
                ...
                :class="{ 'cf-error': errors.message, 'cf-ok': !errors.message && form.message }"
          ...
          <div v-else class="form-success">
            <svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#27ae60" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
              <path d="M22 11.08V12a10 10 0 1 1-5.93-9.14" />
              <polyline points="22 4 12 14.01 9 11.01" />
            </svg>
            Vielen Dank, <strong>{{ senderName }}</strong>!<br>
...
.page-hero {
  ...
  &::before {
    ...
    inset: 0;
    background:
      radial-gradient(ellipse at 30% 60%, rgba(192, 57, 43, .25) 0%, transparent 65%),
      radial-gradient(ellipse at 70% 40%, rgba(192, 57, 43, .15) 0%, transparent 55%);
    z-index: 1;
  }
...
.breadcrumb {
  ...
  a { color: $red; text-decoration: none; transition: opacity $transition; &:hover { opacity: .8; } }
}

// ── Contact Section ──────────────────────────────────────────
.contact-page { padding: 5rem 0; background: #f7f4f0; }
...
.contact-info-col {
  ...
  &__head {
    ...
    p { font-size: .9rem; color: rgba(255, 255, 255, .45); line-height: 1.65; }
  }
}
...
.contact-item {
  ...
  &__text {
    ...
    small { display: block; color: rgba(255, 255, 255, .4); font-size: .82rem; margin-top: .2rem; }
  }
}
...
.hours-table {
  ...
  td { padding-bottom: .3rem; color: rgba(255, 255, 255, .65); }
  td:last-child { text-align: right; font-weight: 600; color: $white; }
}
...
.cf-error { border-color: $red !important; background: #fff8f8 !important; }
.cf-ok    { border-color: $green !important; }
...
.form-success {
  ...
  text-align: center;
  line-height: 1.65;
  animation: revealUp .4s ease;

  svg { display: block; margin: 0 auto .75rem; }
}
...
.cf-map-btn {
  ...
  &:hover { border-color: $white; background: rgba(255, 255, 255, .08); }
}
...
.map-visual {
  ...
  &__dot {
    ...
    background: $red;
    border-radius: 50%;
    box-shadow: 0 0 0 10px rgba(192, 57, 43, .18), 0 0 0 22px rgba(192, 57, 43, .08);
    animation: pulse 2s ease-in-out infinite;
  }

  &__label { color: rgba(255, 255, 255, .5); font-size: .88rem; margin-top: .25rem; }
}

@keyframes pulse {
  0%, 100% { box-shadow: 0 0 0 10px rgba(192, 57, 43, .18), 0 0 0 22px rgba(192, 57, 43, .08); }
  50%       { box-shadow: 0 0 0 14px rgba(192, 57, 43, .22), 0 0 0 30px rgba(192, 57, 43, .05); }
}
